...
[下载最新 Beta](https://github.com/lijingpeng/codexbridge/releases) · [报告问题](https://github.com/lijingpeng/codexbridge/issues)
...
```bash
shasum -a 256 -c Codex-Bridge-1.1.0-beta-universal.dmg.sha256
```
